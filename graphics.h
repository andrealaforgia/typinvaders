...
graphics_context_t
init_graphics_context(int display, int display_mode, window_mode_t window_mode);
...
void draw_line_between_points(const graphics_context_ptr graphics_context,
                              ...
                              const point_ptr p2,
                              color_t color);
void draw_line(const graphics_context_ptr graphics_context,
               int x1,
               int y1,
               int x2,
               int y2,
               color_t color);
void draw_rectangle(const graphics_context_ptr graphics_context,
                    int x1,
                    int y1,
                    int x2,
                    int y2,
                    color_t color);
void draw_pixel(const graphics_context_ptr graphics_context,
                int x,
                int y,
                color_t color);
...
point_t random_point_around(const point_ptr point,
                            int min_tolerance,
                            int max_tolerance);
