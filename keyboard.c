...
ALWAYS_INLINE bool
is_space_key_pressed(const keyboard_state_ptr keyboard_state) {
...
ALWAYS_INLINE bool
is_down_key_pressed(const keyboard_state_ptr keyboard_state) {
...
ALWAYS_INLINE bool
is_left_key_pressed(const keyboard_state_ptr keyboard_state) {
...
ALWAYS_INLINE bool
is_right_key_pressed(const keyboard_state_ptr keyboard_state) {
...
ALWAYS_INLINE bool
is_return_key_pressed(const keyboard_state_ptr keyboard_state) {
